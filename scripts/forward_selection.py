...
def forward_selection(df, plots_dir, model_name, dataset_name, path_to_csv, cl, feature_prefixes):
    """
    ...
    baseline_result = evaluate_model(model_name, dataset_name, path_to_csv, 'baseline',
